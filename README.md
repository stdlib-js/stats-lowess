...
```javascript
lowess = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-lowess@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-lowess@umd/bundle.js"></script>
```
...
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/plot-ctor@umd/bundle.js"></script>
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-lowess@umd/bundle.js"></script>
<script type="text/javascript">
(function () {
